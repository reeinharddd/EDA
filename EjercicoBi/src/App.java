...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        String[] materias = { "Alumno", "Informatica", "Programacion", "Redes", "Promedio" };
        int fila = 5, col = 3;
        ...
        for (int i = 0; i < col; i++) {
            System.out.println("Ingrese las calificaciones de la materia " + materias[i + 1]);
        ...
        for (int i = 0; i < promedio.length; i++) {
            ...
            System.out.println("El promedio del alumno " + (i + 1) + " es: " + promedio[i]);
        }
        ...
        for (int i = 0; i < promedioMateria.length; i++) {
            ...
            System.out.println("El promedio de la materia " + materias[i + 1] + " es: " + promedioMateria[i]);
        }
        ...
        for (int i = 0; i < promedioMateria.length; i++) {
            System.out.print(promedioMateria[i] + "\t");
